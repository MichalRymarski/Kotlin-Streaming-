...
set CLASSPATH=%APP_HOME%\lib\KtorWebsite-HTMX-TAILWIND-all.jar

@rem Execute KtorWebsite-HTMX-TAILWIND
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KTOR_WEBSITE_HTMX_TAILWIND_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KTOR_WEBSITE_HTMX_TAILWIND_EXIT_CONSOLE%" exit 1
exit /b 1
